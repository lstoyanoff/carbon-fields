...
class Association_Field extends Field {
	...
	public function get_thumbnail_by_type( $id, $type, $subtype = '' ) {
		return Helper::get_association_item_thumbnail_by_type( $id, $type, $subtype, $this->get_base_name() );
	}
	...
	public function get_title_by_type( $id, $type, $subtype = '' ) {
		return Helper::get_association_item_title_by_type( $id, $type, $subtype, $this->get_base_name() );
	}
	...
	public function get_item_label( $id, $type, $subtype = '' ) {
		return Helper::get_association_item_label( $id, $type, $subtype, $this->get_base_name() );
	}
